      ...
      <div className="row margin-bottom-0">
        <div className="col s12 m6 l6 xl6 offset-l3 offset-m3 offset-xl3 margin-top-7vh">
          <div id="no-responsive" className="center-align">
              <svg className="icon">
                <use xlinkHref={`${url}#007-roundabout`}></use>
              </svg>
              <h4 className="white-text padding-top-3vh">{this.props && this.props.fields && this.props.fields.RESEND && this.props.fields.RESEND.title}</h4>
          </div>
            <div className="card col s12 m12 l12 xl12  margin-top-7vh">
              <div className="card-content">
                <p id="responsive" className="center font-35-custom">{this.props && this.props.fields && this.props.fields.RESEND && this.props.fields.RESEND.title}</p>
                <div className="body-login">
                  <div className="center margin-top-10">
                    <h5>{this.props && this.props.fields && this.props.fields.RESEND && this.props.fields.RESEND.description}</h5>
...
export default connect(mapStateToProps, actions)(withRouter(Resend));
